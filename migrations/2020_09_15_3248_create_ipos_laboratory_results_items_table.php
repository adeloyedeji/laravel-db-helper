...
class CreateIposLaboratoryResultsItemsTable extends Migration
{
	/**
	* Run the migrations.
	*
	...
	*/
	public function up()
	{
		Schema::create('ipos_laboratory_results_items', function (Blueprint $table) {
			$table->id();
	...
	*/
	...
	{
		Schema::dropIfExists('ipos_laboratory_results_items');
	}
}